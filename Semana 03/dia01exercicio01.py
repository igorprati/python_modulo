# Listas compostas são lsitas dentro de listas, com os conceitos ensinados anteriormente, nós conseguimos criar a seguinte lista:
...
listaMaior = list()
dados = list()
pessoasCad = maiorPeso = menorPeso = maior = menor = 0

while True:
    dados.append(str(input('\nDigite o seu nome: ')))
    pessoasCad += 1

    dados.append(float(input('Digite sua seu peso: ')))
...
print(f'Foram {pessoasCad} pessoas cadastradas.\nO maior peso foi')
